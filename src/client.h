 ...
 *               message.
 * @param read_fd An fd_set struct used to clear the file descriptor from the socket. *************** What
 */
 ...
 * connection to the server was lost. If none of these are true, the received packet
 * is used to add a null character to the end of the received string buffer. The 
 * buffer contains a string representing the user's username, timestamp of the
 * message, and message. This buffer is then printed to the user's terminal.
 *
 * @param packet_received An integer representing the status of the received packet
